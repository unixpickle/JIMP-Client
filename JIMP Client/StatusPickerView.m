...
- (id)initWithFrame:(NSRect)frame {
    if ((self = [super initWithFrame:frame])) {
		...
		if (myArray) {
			...
			[menuItems addObject:[StatusPickerMenuItem menuItemWithStatus:invisible]];
			[menuItems addObject:[StatusPickerMenuItem menuItemWithStatus:available]];
			[menuItems addObject:[StatusPickerMenuItem menuItemWithStatus:away]];
			[invisible release];
			[available release];
			[away release];
		}
